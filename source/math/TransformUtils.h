...
class TransformUtils
{
   public:
	...
	static glm::mat4 createRotationMatrix(const glm::vec3& up, const glm::vec3& right, const glm::vec3& forward);

	static glm::vec3 createRotation(const glm::vec3& up, const glm::vec3& right, const glm::vec3& forward);
