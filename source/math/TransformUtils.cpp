...
glm::mat4 TransformUtils::createRotationMatrix(const glm::vec3& up, const glm::vec3& right, const glm::vec3& forward)
{
...
glm::vec3 TransformUtils::createRotation(const glm::vec3& up, const glm::vec3& right, const glm::vec3& forward)
{
	glm::vec4 rotation = createRotationMatrix(up, right, forward) * glm::vec4(0.f, 0.f, 0.f, 0.f);
	return glm::vec3(rotation.x, rotation.x, rotation.z);
}
