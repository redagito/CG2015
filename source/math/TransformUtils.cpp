...
glm::vec3 TransformUtils::rotate(const glm::vec3& vector, const glm::vec3& rotation)
{
...
glm::vec3 TransformUtils::createRotation(const glm::mat4& rotation)
{
	...
	{
		return glm::vec3(std::atan2(-rotation[2][0], rotation[0][0]), std::asin(rotation[1][0]), std::atan2(-rotation[1][2], rotation[1][1]));
	}
}
