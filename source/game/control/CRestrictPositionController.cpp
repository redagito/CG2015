...
CRestrictPositionController::CRestrictPositionController(const glm::vec2& minCoords, const glm::vec2& maxCoords)
	:
...
void CRestrictPositionController::detach()
{
	m_object = nullptr;
}

void CRestrictPositionController::setActive(bool state)
{
	m_active = state;
}
