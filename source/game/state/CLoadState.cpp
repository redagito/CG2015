...
CLoadState::CLoadState(const std::string& sceneFile, float transitionTime)
	:
	m_sceneFile(sceneFile), m_transitionTime(transitionTime)
{
...
bool CLoadState::init(IGraphicsSystem* graphicsSystem, IInputProvider* inputProvider, IResourceManager* resourceManager)
{
