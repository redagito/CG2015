...
CSineTranslationController::CSineTranslationController(SceneObjectId id, AnimationObjectType type, IScene& scene, const glm::vec3& translation, float timeScale)
	:
	m_objectId(id),
	m_type(type),
	m_scene(scene),
