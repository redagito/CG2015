#include "StdStreamDeserializer.h"
...
template <typename T>
bool deserializeNative(std::istream& stream, T& value)
{
...
bool deserialize(std::istream& stream, bool& value) { return deserializeNative(stream, value); }

bool deserialize(std::istream& stream, int8_t& value) { return deserializeNative(stream, value); }

bool deserialize(std::istream& stream, int16_t& value) { return deserializeNative(stream, value); }

bool deserialize(std::istream& stream, int32_t& value) { return deserializeNative(stream, value); }

bool deserialize(std::istream& stream, int64_t& value) { return deserializeNative(stream, value); }

bool deserialize(std::istream& stream, uint8_t& value) { return deserializeNative(stream, value); }

bool deserialize(std::istream& stream, uint16_t& value) { return deserializeNative(stream, value); }

bool deserialize(std::istream& stream, uint32_t& value) { return deserializeNative(stream, value); }

bool deserialize(std::istream& stream, uint64_t& value) { return deserializeNative(stream, value); }

bool deserialize(std::istream& stream, float& value) { return deserializeNative(stream, value); }

bool deserialize(std::istream& stream, double& value) { return deserializeNative(stream, value); }
